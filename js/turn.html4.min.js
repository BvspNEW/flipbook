...
(function (f) {
  ...
  function t(a, b, c, d, e) {
    var g = 1 - e,
      ...
      l = e * e * e;
    return m(
      Math.round(f * a.x + 3 * e * g * g * b.x + 3 * e * e * g * c.x + l * d.x),
      Math.round(f * a.y + 3 * e * g * g * b.y + 3 * e * e * g * c.y + l * d.y)
    );
  }
  function m(a, b) {
    return { x: a, y: b };
  ...
  var r = "",
    ...
    p = { backward: ["l"], forward: ["r"], all: ["l", "r"] },
    x = ["single", "double"],
    y = ["ltr", "rtl"],
    z = {
      acceleration: !0,
    ...
    i = {
      init: function (a) {
        ...
        for (
          var b = ["Moz", "Webkit", "Khtml", "O", "ms"], c = b.length, d = "";
          c--;

        )
          b[c] + "Transform" in document.body.style &&
            (d = "-" + b[c].toLowerCase() + "-");
        r = d;
        var e,
          b = 0,
        ...
        g.docEvents = {
          mouseStart: function (a) {
            for (var b in g.pages)
              if (j(b, g.pages) && !1 === h._eventStart.call(g.pages[b], a))
                return !1;
          },
          mouseMove: function (a) {
            for (var b in g.pages)
              j(b, g.pages) && h._eventMove.call(g.pages[b], a);
          },
          mouseEnd: function (a) {
            for (var b in g.pages)
              j(b, g.pages) && h._eventEnd.call(g.pages[b], a);
          },
        };
        ...
        for (e = 0; e < c.length; e++)
          "1" != f(c[e]).attr("ignore") && this.turn("addPage", c[e], ++b);
        f(this)
          .bind(n.down, g.docEvents.mouseStart)
          .bind("start", i._start)
          .bind("end", i._end)
          .bind("pressed", i._pressed)
          .bind("released", i._released)
          .bind("flip", i._flip);
        f(document)
          .bind(n.move, g.docEvents.mouseMove)
          .bind(n.up, g.docEvents.mouseEnd);
      ...
      addPage: function (a, b) {
        ...
        1 <= b &&
          ...
          b in e.pageObjs && i._movePages.call(this, b, 1),
          d && (e.totalPages = g),
          (e.pageObjs[b] = f(a)
            .css({ float: "left" })
            .addClass("page p" + b + c)),
          i._addPage.call(this, b),
          e.done && this.turn("update"),
          i._removeFromDOM.call(this));
        return this;
      },
      _addPage: function (a) {
        var b = this.data(),
        ...
        if (c)
          if (i._necessPage.call(this, a)) {
            ...
            (!a || 1 == i._setPageLoc.call(this, a)) &&
              i._makeFlip.call(this, a);
      ...
      destroy: function () {
        ...
        for (
          f(document)
            .unbind(n.move, a.docEvents.mouseMove)
            .unbind(n.up, a.docEvents.mouseEnd);
          0 !== a.totalPages;

        )
          this.turn("removePage", a.totalPages);
      ...
      zoom: function (a) {
        var b = this.data();
        if ("number" == typeof a) {
          if (0.001 > a || 100 < a) throw k(a + " is not a value for zoom");
          ...
          f(this)
            .turn("stop")
            .turn("size", e, g)
            .css({ marginTop: (c.height * d) / 2 - g / 2 });
          b.opts.autoCenter
            ? this.turn("center")
            : f(this).css({ marginLeft: (c.width * d) / 2 - e / 2 });
      ...
      range: function (a) {
        ...
        if (1 > a || a > e.totalPages)
          throw k('"' + a + '" is not a page for range');
        d[1] = d[1] || d[0];
      ...
      _removeFromDOM: function () {
        ...
        for (a in b.pageWrap)
          j(a, b.pageWrap) &&
            !i._necessPage.call(this, a) &&
            i._removePageFromDOM.call(this, a);
      },
      ...
      removePage: function (a) {
        ...
        if (1 > a || a > b.totalPages)
          throw k("The page " + a + " doesn't exist");
        b.pageObjs[a] &&
          (this.turn("stop"),
          i._removePageFromDOM.call(this, a),
          delete b.pageObjs[a]);
      ...
      display: function (a) {
        ...
        if (a) {
          if (-1 == f.inArray(a, x))
            throw k('"' + a + '" is not a value for display');
          "single" == a
            ? b.pageObjs[0] ||
      ...
      direction: function (a) {
        ...
        a = a.toLowerCase();
        if (-1 == f.inArray(a, y))
          throw k('"' + a + '" is not a value for direction');
      ...
      disable: function (a) {
        ...
        for (b in c.pages)
          j(b, c.pages) && c.pages[b].flip("disable", a ? f.inArray(b, d) : !1);
        return this;
      },
      disabled: function (a) {
        return void 0 === a
      ...
      size: function (a, b) {
        if (a && b) {
          ...
          for (c in e.pageWrap)
            j(c, e.pageWrap) &&
              ((d = i._pageSize.call(this, c, !0)),
              e.pageObjs[c].css({ width: d.width, height: d.height }),
              e.pageWrap[c].css(d),
              e.pages[c] &&
                e.pages[c].css({ width: d.width, height: d.height }));
          this.turn("resize");
          return this;
        }
      ...
      stop: function () {
        if (this.turn("animating")) {
          ...
          for (a = 0; a < e.length; a++)
            (c = d.pages[e[a]]),
              (b = c.data().f.opts),
              c.flip("hideFoldedPage", !1),
              h._moveFoldingPage.call(c, !1),
              (d.pagePlace[b.next] = b.next),
              b.force &&
                ((b.next = 0 === b.page % 2 ? b.page - 1 : b.page + 1),
                delete b.force);
        }
        this.turn("update");
        return this;
      ...
      _missing: function (a) {
        for (
          var b = this.data(), c = this.turn("range", a), d = [], a = c[0];
          a <= c[1];
          a++
        )
      ...
      _turnPage: function (a, b) {
        ...
        "single" == e.display
          ...
          : h[1] && a > h[1]
          ? ((c = h[1]), (d = l[0]))
          : h[0] && a < h[0] && ((c = h[0]), (d = l[1]));
        e.pages[c] &&
          ((g = e.pages[c].data().f.opts),
          (e.tpage = d),
          g.next != d &&
            ((g.next = d), (e.pagePlace[d] = g.page), (g.force = !0)),
          "single" == e.display
            ? "ltr" == e.direction
              ? e.pages[c].flip("turnPage", l[0] > h[0] ? "r" : "l")
              : e.pages[c].flip("turnPage", l[0] > h[0] ? "l" : "r")
            : e.pages[c].flip("turnPage"));
      },
      page: function (a) {
        var a = parseInt(a, 10),
          b = this.data();
        return 0 < a && a <= b.totalPages
          ? (!b.done || -1 != f.inArray(a, this.turn("view"))
              ? i._fitPage.call(this, a)
              : i._turnPage.call(this, a),
            this)
          : b.page;
      },
      next: function () {
        return this.turn(
          "page",
          i._view.call(this, this.data().page).pop() + 1
        );
      },
      previous: function () {
        return this.turn(
          ...
          ("single" == d.display &&
            ...
            ("r" == c && "rtl" == d.direction)
              ? ((b.next = b.next < b.page ? b.next : b.page - 1),
                (b.force = !0))
              : (b.next = b.next > b.page ? b.next : b.page + 1)),
          i._addMotionPage.call(a.target));
      ...
      _end: function (a, b, c) {
        ...
        var a = b.turn,
          d = a.data();
        if (c || d.tpage) {
          if (d.tpage == b.next || d.tpage == b.page)
            delete d.tpage, i._fitPage.call(a, d.tpage || b.next, !0);
        } else
          i._removeMv.call(a, b.page),
            i._updateShadow.call(a),
            a.turn("update");
      },
      _pressed: function (a) {
        a.stopPropagation();
        ...
        c =
          "single" == u.display
            ? "r" == b.corner
              ...
              : b.x > d.width() / 2
            : 0 > b.x || b.x > d.width();
        if (200 > new Date().getTime() - e.time || c)
          a.preventDefault(),
            i._turnPage.call(
              g,
              e.opts.next,
              !1 === h._cornerActivated.call(d, b, 1)
            );
        u.mouseAction = !1;
      },
      _flip: function (a) {
      ...
      calculateZ: function (a) {
        ...
        for (b = 0; b < a.length; b++)
          (c = a[b]),
            ...
            (i.pageZ[c] = f.totalPages - Math.abs(h - c)),
            (i.partZ[e] = 2 * f.totalPages + Math.abs(h - c));
        return i;
      },
      update: function () {
        var a,
          ...
          for (a in b.pageWrap)
            if (
              ...
              c.flip("z", d.partZ[a] || null),
                ...
                b.tpage && c.flip("disable", !0);
        } else
          for (a in b.pageWrap)
            j(a, b.pageWrap) &&
              ((d = i._setPageLoc.call(this, a)),
              b.pages[a] &&
                b.pages[a]
      ...
      _updateShadow: function () {
        ...
        for (var h = 0; h < c.pageMv.length && a[0] && a[1]; h++)
          (a = this.turn("view", c.pages[c.pageMv[h]].data().f.opts.next)),
            (b = this.turn("view", c.pageMv[h])),
            (a[0] = a[0] && b[0]),
            (a[1] = a[1] && b[1]);
        switch (
          a[0]
      ...
      _setPageLoc: function (a) {
        var b = this.data(),
          c = this.turn("view");
        if (a == c[0] || a == c[1])
          return b.pageWrap[a].css({ zIndex: b.totalPages, display: "" }), 1;
        if (
          ...
          return (
            b.pageWrap[a].css({ zIndex: b.totalPages - 1, display: "" }), 2
          );
        b.pageWrap[a].css({
          zIndex: 0,
      ...
      options: function (a) {
        ...
        if (a.when)
          for (var c in a.when)
            j(c, a.when) && this.unbind(c).bind(c, a.when[c]);
        return this;
      },
      version: function () {
        return "4.1.0";
    ...
    h = {
      ...
      options: function (a) {
        var b = this.data().f;
        return a
          ? (h.setData.call(this, { opts: f.extend({}, b.opts || A, a) }), this)
          : b.opts;
      },
      z: function (a) {
        var b = this.data().f;
      ...
      _cornerActivated: function (a) {
        ...
        if (a.x > d - b) a.corner = "r";
        else if (a.x < b) a.corner = "l";
        else return !1;
      ...
      resize: function (a) {
        var b = this.data().f,
          ...
          d = this.height();
        a &&
          (b.wrapper.css({ width: c, height: d }),
      ...
      _fold: function (a) {
        ...
        switch (a.corner) {
          case "r":
            ...
            this.css({ position: "relative", left: -c });
            b.fpage.css({ left: -c + d, width: Math.max(0, c - d) });
            break;
          case "l":
            b.wrapper.css({ width: d }),
              this.css({ position: "relative", left: c }),
              b.fpage.css({ left: d, width: Math.max(0, c - d) }),
              b.folding &&
                b.folding.css({ position: "relative", left: 2 * -d + c });
        }
      ...
      _moveFoldingPage: function (a) {
        ...
        if (a) {
          ...
          if (a) {
            ...
            h.setData.call(this, { backParent: a.parent(), folding: a });
            b.fpage.prepend(a);
          }
          c.turn("update");
        } else
          b.backParent &&
            (b.backParent.prepend(b.folding),
            delete b.backParent,
            delete b.folding);
      },
            ...
            var g = h._c.call(this, d.corner),
              a =
                "t" == d.corner.substr(0, 1)
                  ? Math.min(0, d.y - g.y) / 2
                  : Math.max(0, d.y - g.y) / 2,
              f = m(d.x, d.y + a),
              i = m(g.x, g.y - a);
            this.animatef({
              from: 0,
        ...
        var b = this,
          ...
          d =
            ...
            h._c.call(
              this,
              a.corner,
              c.opts.turn ? c.opts.turn.data().opts.elevation : 0
            ),
      ...
      _eventStart: function (a) {
        ...
        if (!b.disabled && !this.flip("isTurning")) {
          ...
          if (b.corner && h._foldingPage.call(this, b.corner))
            return (
      ...
      _eventMove: function (a) {
        ...
        if (!b.disabled)
          if (((a = [a]), b.corner)) {
            ...
            !this.data().effect &&
              this.is(":visible") &&
              ((a = h._cornerActivated.call(this, a[0]))
          ...
          var c = [],
            ...
            i = function () {
              if (b.effect && e) {
                for (
                  var f = [],
                    j = Math.min(a.duration, new Date().getTime() - h),
                    k = 0;
                  k < d;
                  k++
                )
                  f.push(b.effect.easing(1, j, a.from[k], c[k], a.duration));
                a.frame(1 == d ? f[0] : f);
                j == a.duration
                  ? (delete b.effect, g.data(b), a.complete && a.complete())
                  : window.requestAnim(i);
              }
            },
            j = 0;
          j < d;
